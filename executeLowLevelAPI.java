...
this function execute SMSme command as an example for low level command execution
	public void smsME(String text,String Device)throws Exception 
	{
		...
		String cmd =   "https://"+Constants.PM_CLOUD+"/services/executions/"+execID+"?user="+Constants.PM_USER+"&password="+Constants.PM_PASSWORD+"&operation=command&command=gateway&subcommand=sms&param.body=aaa&param.to.handset=3152168C4EAA1E2A5DE93CF7B89222720E3A62E0";
